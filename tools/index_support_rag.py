...
def main() -> None:
    ...
    parser.add_argument("--batch-size", type=int, default=128, help="Number of examples to process per Qdrant batch")
    args = parser.parse_args()

    result = index_support_kb(kb_dir=args.kb_dir, use_qdrant=not args.no_qdrant, batch_size=args.batch_size)
